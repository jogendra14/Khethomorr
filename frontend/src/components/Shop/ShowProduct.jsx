      ...
      <Link to={`/product/${product._id}`}>
        ...
        <div className="px-2 mt-2.5 md:pb-1">
          <button onClick = { () => addToCart(product) }
            className="w-full flex justify-center items-center gap-2 mt-1 border text-red-500 font-medium border-red-600 hover:bg-red-600 hover:text-white rounded-xs md:rounded-md py-1 md:py-1">
              <BsCartCheck/>
