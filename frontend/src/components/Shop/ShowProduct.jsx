    ...
    <div className="bg-white rounded-sm shadow hover:shadow-lg duration-300 pb-1.5 overflow-hidden group">
      <Link to={`/product/${product._id}`}>
        ...
        <div className="mx-3 my-1">
          <h2 className="text-sm md:text-base font-medium line-clamp-2 ">{product.name}</h2>
          ...
          <div className="mt-1">
            ...
            <span className="ml-1 font-semibold line-through text-sm md:text-md text-gray-500">{product.MRP}</span>
            <span className=" font-bold text-red-600 text-sm md:text-[15px] ml-1.5 ">
